...
@SP
M=M+1
//writing call Stata.getVal
@Main.Main.dump$ret.8
D=A
@SP
A=M
M=D
...
A=M
M=D
//writing call Statb.getVal
@Main.Main.dump$ret.9
D=A
@SP
A=M
M=D
